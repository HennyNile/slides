...
import { DeckPlayer, type DeckSpec, type SlideSpec } from "../../components/deck-player";
import { paperReadingMetadata } from "../../lib/decks";
    ...
    body: (
      <div className="cover-copy">
        ...
        <div className="cover-meta">
          <b>{paperReadingMetadata.author}</b>
          <span>Summer School · {paperReadingMetadata.year}</span>
        </div>
      </div>
    ),
  },
  ...
  },
  {
    ...
    body: (
      ...
      >
        ...
        <img
          src="../decks/how-to-read-paper/field-map-ai4db.png"
        ...
        <div className="alaya-figure-grid">
          <figure>
            <div className="alaya-figure-frame architecture">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="../decks/how-to-read-paper/alayadb-system-overview.png"
          ...
          <figure>
            <div className="alaya-figure-frame result">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="../decks/how-to-read-paper/alayadb-quality-memory.png"
...
const paperReadingDeck: DeckSpec = {
  mark: "CS",
  identityTitle: paperReadingMetadata.shortTitle,
  identitySubtitle: `${paperReadingMetadata.author} · 网页演示版`,
  slides,
};

export function PaperReadingPresentation() {
  return <DeckPlayer deck={paperReadingDeck} />;
}
